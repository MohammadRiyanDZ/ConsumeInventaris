...
export default function Stuff() {
    ...
    function handleStoreStock(id) {
        ...
        instance.post('stuff-stock/add-stock{id}', stock)
        .then(res => {
                            ...
                            <tbody>
                                {stuffs.map((stuff, id) => (
                                    <tr key={stuff.id} className="border-b dark:border-neutral-500">
                                        <td className="text-black px-6 py-4">{id + 1}</td>
                                        <td className="text-black px-6 py-4">{stuff.id}</td>
                                        <td className="text-black px-6 py-4">{stuff.name}</td>
                                        <td className="text-black px-6 py-4">{stuff.category}</td>
                                        {
                                            stuff.stock ? (
