                        ...
                        <div className="flex items-center">
                            ...
                            {isLogin && authUser ? (
                                <>
                                    {authUser.role === 'admin' && (
                                        <div className="flex items-center">
                                            <Link to="/stuff/data"><small className="text-white ms-3">Stuff</small></Link>
                                            <Link to="/inbound-stuff/data"><small className="text-white ms-3">Inbound</small></Link>
                                            <Link to="/lending/data"><small className="text-white ms-3">Lending</small></Link>
                                            <Link to="/user/data"><small className="text-white ms-3">User</small></Link>
                                        </div>
                                    )}
                                    {authUser.role === 'staff' && (
                                        <Link to="/lending/data"><small className="text-white ms-3">Lending</small></Link>
